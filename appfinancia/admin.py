...
class PrestamosAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        ...
        #'asesor_id__nombre',
        #'prestamo_id__id',
        'prestamo_id__prestamo_id__exact', # Si quieres buscar por el ID del desembolso. 2025/12/05.pam
...
class HistoriaPrestamosAdmin(admin.ModelAdmin):
    ...
    list_filter = ('prestamo_id',)                                     #2025/12/05 pam
    search_fields = ('prestamo_id__prestamo_id__exact','numero_cuota') #2025/12/05 pam
