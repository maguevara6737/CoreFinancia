...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('appfinancia', '0041_remove_prestamos_id_alter_prestamos_prestamo_id'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banco_origen', models.CharField(help_text='Nombre del banco emisor del archivo.', max_length=100)),
                ('valor_total', models.DecimalField(decimal_places=2, default=0, help_text='Valor total consolidado del archivo.', max_digits=15)),
                ('estado_proceso_archivo', models.CharField(choices=[('RECIBIDO', 'Recibido'), ('PROCESADO', 'Procesado'), ('ANULADO', 'Anulado')], default='RECIBIDO', help_text='Estado del procesamiento del archivo.', max_length=10)),
